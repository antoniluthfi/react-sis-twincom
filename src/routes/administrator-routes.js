...
const PenerimaanBarang = React.lazy(() => import('../views/administrator/transaksi/penerimaan-barang/PenerimaanBarang'));
const PengembalianBarang = React.lazy(() => import('../views/administrator/transaksi/pengembalian-barang/PengembalianBarang'));
const ArusKas = React.lazy(() => import('../views/administrator/transaksi/arus-kas/ArusKas'));
const Pembayaran = React.lazy(() => import('../views/administrator/pembayaran/Pembayaran'));
const PengirimanBarang = React.lazy(() => import('../views/administrator/pengiriman/pengiriman-barang/PengirimanBarang'));
const PenerimaanBarangPartner = React.lazy(() => import('../views/administrator/pengiriman/penerimaan-barang/PenerimaanBarangPartner'));
const TagihanPartner = React.lazy(() => import('../views/administrator/pengiriman/tagihan-partner/TagihanPartner'));
const Pengerjaan = React.lazy(() => import('../views/administrator/pengerjaan/barang-jasa/Pengerjaan'));
const PembelianBarangSecond = React.lazy(() => import('../views/administrator/pengajuan/PembelianBarangSecond')); // pengajuan
const PembelianBarangSecond2 = React.lazy(() => import('../views/administrator/pengerjaan/pembelian-barang-second/PembelianBarangSecond')); // pengerjaan
const LogAktivitas = React.lazy(() => import('../views/administrator/log-aktivitas/LogAktivitas'));

const administratorRoutes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/dashboard', name: 'Dashboard', component: DashboardAdministrator },
