...
const Pengerjaan = lazy(() => import('../views/teknisi/pengerjaan/barang-jasa/Pengerjaan'));
const PembelianBarangSecond = lazy(() => import('../views/teknisi/pengerjaan/pembelian-barang-second/PembelianBarangSecond'));
...
const teknisiRoutes = [
    ...
    { path: '/dashboard', name: 'Dashboard', component: DashboardTeknisi },
