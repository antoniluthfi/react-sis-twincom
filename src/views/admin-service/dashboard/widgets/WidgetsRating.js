            ...
            <CRow>
                <CCol sm="6" lg="6">
                    <CWidgetDropdown
                        ...
                        header={loadData ? 0 : ourRating == 0 || ourRating == null ? "Belum ada penilaian" : `Rata-rata ${ourRating} Bintang`} 
                ...
                <CCol sm="6" lg="6">
                    <CWidgetDropdown
                        color="gradient-info"
                        header={loadData ? 0 : ratingCabang == 0 || ratingCabang == null ? "Belum ada penilaian" : `Rata-rata ${ratingCabang} Bintang`} 
