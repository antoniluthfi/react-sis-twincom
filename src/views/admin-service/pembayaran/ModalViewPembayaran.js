                            ...
                            <CRow>
                                ...
                                <CCol xs="12" md="6">
                                    <CFormGroup>
                                        ...
                                        <CInput type="text" id="nomor-service" name="no_service" value={`${kodeCabang(currentPembayaran.penerimaan.cabang.nama_cabang.toLowerCase())}${currentPembayaran.no_service}`} placeholder="Masukkan Nomor Pembayaran" disabled={true} />
                                    </CFormGroup>
                                </CCol>
                            </CRow>
