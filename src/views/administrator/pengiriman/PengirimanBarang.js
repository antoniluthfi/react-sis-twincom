                                    ...
                                    'details':
                                        ...
                                        <CCollapse show={details.includes(index)}>
                                            <CCardBody>
                                                ...
                                                <a href={`${process.env.REACT_APP_PUBLIC_URL}/surat-jalan/${item.no_surat_jalan}`} target="_blank">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th className="text-center">
                                            <Button onClick={addBarangHandler}>
                                ...
                                <tbody>
                                    {inputBarang.map((inbar, i) => (
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-center">
                                                <Button onClick={removeBarangHandler}>
