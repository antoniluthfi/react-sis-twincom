...
const DataAdminServiceHelper = () => {
    ...
    const postDataAdminService = async () => {
        ...
        if(message) {
            ...
            .then(response => {
                ...
                writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Admin Service', 'POST', `${currentUser.name} menambahkan ${response.data.data.name} sebagai data baru`);
                getDataAdminService();
                closeModalHandler();
            })
            .catch(error => {
    ...
    const updateDataAdminService = async id => {
        ...
        if(message) {
            ...
            .then(response => {
                ...
                writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Admin Service', 'UPDATE', `${currentUser.name} mengubah data ${currentDataAdminService.name}`);
                getDataAdminService();
                closeModalHandler();
            })
            .catch(error => {
    ...
    const deleteDataAdminService = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Admin Service', 'DELETE', `${currentUser.name} menghapus data ${currentDataAdminService.name}`);
            getDataAdminService();
        })
        .catch(error => {
            Swal.fire(
