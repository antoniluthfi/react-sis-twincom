...
const DataSalesHelper = () => {
    ...
    const submitHandler = action => {
        if(action === 'Submit') {
            ...
            deleteDataSales(currentDataSales.id);
        }
    }
    ...
    const postDataSales = async () => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Sales', 'POST', `${currentUser.name} menambahkan ${response.data.data.name} sebagai data baru`);
            getDataSales();
        })
        .catch(error => {
            Swal.fire(
    ...
    const updateDataSales = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Sales', 'UPDATE', `${currentUser.name} mengubah data ${currentDataSales.name}`);
            getDataSales();
        })
        .catch(error => {
            Swal.fire(
    ...
    const deleteDataSales = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Sales', 'DELETE', `${currentUser.name} menghapus data ${currentDataSales.name}`);
            getDataSales();
        })
        .catch(error => {
            Swal.fire(
