...
const DataAdministratorHelper = () => {
    ...
    const submitHandler = action => {
        if(action === 'Submit') {
            ...
            deleteDataAdminstrator(currentDataAdministrator.id);
        }
    }
    ...
    const postDataAdministrator = async () => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Administrator', 'POST', `${currentUser.name} menambahkan ${response.data.data.name} sebagai data baru`);
            getDataAdministrator();
        })
        .catch(error => {
            Swal.fire(
    ...
    const updateDataAdministrator = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Administrator', 'UPDATE', `${currentUser.name} mengubah data ${currentDataAdministrator.name}`);
            getDataAdministrator();
        })
        .catch(error => {
            Swal.fire(
    ...
    const deleteDataAdminstrator = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, role, 'Data Administrator', 'DELETE', `${currentUser.name} menghapus data ${currentDataAdministrator.name}`);
            getDataAdministrator();
        })
        .catch(error => {
            Swal.fire(
