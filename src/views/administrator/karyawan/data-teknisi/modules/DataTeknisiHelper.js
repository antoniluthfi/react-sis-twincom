...
const DataTeknisiHelper = () => {
    ...
    const postDataTeknisi = async () => {
        ...
        if(message != null) {
            ...
            .then(response => {
                ...
                writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Teknisi', 'POST', `${currentUser.name} menambahkan ${response.data.data.name} sebagai data baru`);
                getDataTeknisi();
                closeModalHandler();
            })
            .catch(error => {
    ...
    const updateDataTeknisi = async id => {
        ...
        if(message) {
            ...
            .then(response => {
                ...
                writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Teknisi', 'UPDATE', `${currentUser.name} mengubah data ${currentDataTeknisi.name}`);
                getDataTeknisi();
                closeModalHandler();
            })
            .catch(error => {
    ...
    const deleteDataTeknisi = async id => {
        ...
        .then(response => {
            ...
            writeActivityLog(currentUser.id, currentUser.jabatan, 'Data Teknisi', 'DELETE', `${currentUser.name} menghapus data ${currentDataTeknisi.name}`);
            getDataTeknisi();
        })
        .catch(error => {
            Swal.fire(
