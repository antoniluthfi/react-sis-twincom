...
const PenerimaanBarang = () => {
    ...
    return (
        <>
                    ...
                    {loadCurrentPenerimaan ? 
                        ...
                        <>
                            <CForm action="" method="post">
                                ...
                                <CFormGroup>
                                    <CLabel htmlFor="input-bj">Pilih <span style={{ cursor: 'pointer' }} onClick={() => openBJModalHandler("Jasa")}>Jasa Lain-lain + </span></CLabel>
                                    <Autocomplete
                                        id="input-bj"
                                        disabled={autocompleteDisabled}
                                        options={bjOptions}
            ...
            >
                <CModalHeader closeButton>
                    <CModalTitle>{loadCurrentPenerimaan ? null : 'Hapus Data'}</CModalTitle>
                </CModalHeader>
                <CModalBody>
                    {loadCurrentPenerimaan ? 
                ...
                {loadCurrentPenerimaan ? null :
                    <CModalFooter>
                        <CButton color="danger" onClick={() => submitHandler(buttonDanger)}>{buttonDanger}</CButton>{' '}
