        ...
        <CRow>
            <CCol sm="6" lg="4">
                <CWidgetDropdown
                    ...
                    header={loadData ? "Belum ada penilaian" : ratingBanjarbaru === 0 ? "Belum ada penilaian" : `Rata-rata ${ratingBanjarbaru.slice(0, 3)} Bintang`}
            ...
            <CCol sm="6" lg="4">
                <CWidgetDropdown
                    color="gradient-info"
                    header={loadData ? "Belum ada penilaian" : ratingLandasanUlin === 0 ? "Belum ada penilaian" : `Rata-rata ${ratingLandasanUlin.slice(0, 3)} Bintang`}
            ...
            <CCol sm="6" lg="4">
                <CWidgetDropdown
                    ...
                    header={loadData ? "Belum ada penilaian" : ratingBanjarmasin === 0 ? "Belum ada penilaian" : `Rata-rata ${ratingBanjarmasin.slice(0, 3)} Bintang`}
