...
import DashboardReviewerHelper from './modules/DashboardReviewerHelper';
    ...
    return (
        <div>
            <CRow>
                <CCol xs="12" lg="12">
                    <CCard>
                        ...
                        <CRow>
                            <CCol xs="12" md="6" className="mt-1 mb-0 ml-4">
                                <CButton size="sm" color="success" onClick={() => window.location.reload(true)}>
            ...
            >
                ...
                <CModalFooter>
                    <CButton color="success" onClick={postReviewKepuasan}>Submit</CButton>{' '}
